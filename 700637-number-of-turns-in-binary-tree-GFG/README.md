# [Number of Turns in Binary Tree](https://www.geeksforgeeks.org/problems/number-of-turns-in-binary-tree/1)
## Hard
...
Examples :
Input: root[] = [1, 2, 3, 4, 5, 6, 7, 8, N, N, N, 9, 10], p = 5, q = 10Output: 4
...
Input: root[] = [1, 2, 3, 4, 5, 6, 7, 8, N, N, N, 9, 10], p = 1, q = 4Output: -1
Explanation: No turn is required since they are in a straight line.
Constraints:1 ≤ n ≤ 104, n is the number of nodes1 ≤ node-&gt;data ≤ 1041 ≤ p, q ≤&nbsp;n