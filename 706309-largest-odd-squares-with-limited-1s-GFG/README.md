# [Largest Odd Squares with Limited 1s](https://www.geeksforgeeks.org/problems/largest-square-in-a-binary-matrix-with-at-most-k-1s-for-multiple-queries/1)
## Medium
...
Input: mat[][] = [[1, 1, 1], [1, 1, 1], [1, 1, 1]], queries[][] = [[1, 1], [2, 2]], K = 9Output: [3, 1]
...
Constraints:1 ≤ mat.size(), mat[0].size() ≤ 5001 ≤ queries.size() ≤ 1040 ≤ queries[q][0] &lt; mat.size()0 ≤ queries[q][1] &lt; mat[0].size()0 ≤ k ≤ mat.size() * mat[0].size()